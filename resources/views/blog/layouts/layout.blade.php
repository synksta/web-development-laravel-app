...
<body>
    ...
    <header class="market-header header">
      <div class="container-fluid">
        <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
          ...
          <a class="navbar-brand" href="marketing-index.html"><img src="{{asset('assets/markedia/images/version/market-logo.png')}}" alt=""></a>
            ...
            <div class="page-wrapper">
              <div class="blog-custom-build">
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_01.jpg')}}" alt="" class="img-fluid">
                ...
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_02.jpg')}}" alt="" class="img-fluid">
                      <div class="hovereffect">
                        <span></span>
                      </div>
                      <!-- end hover -->
                ...
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_03.jpg')}}" alt="" class="img-fluid">
                      <div class="hovereffect">
                        <span></span>
                      </div>
                      <!-- end hover -->
                ...
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_04.jpg')}}" alt="" class="img-fluid">
                      <div class="hovereffect">
                        <span></span>
                      </div>
                      <!-- end hover -->
                ...
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_05.jpg')}}" alt="" class="img-fluid">
                      <div class="hovereffect">
                        <span></span>
                      </div>
                      <!-- end hover -->
                ...
                <div class="blog-box wow fadeIn">
                  <div class="post-media">
                    <a href="marketing-single.html" title="">
                      <img src="{{asset('assets/markedia/upload/market_blog_06.jpg')}}" alt="" class="img-fluid">
                      <div class="hovereffect">
                        <span></span>
                      </div>
                      <!-- end hover -->
            ...
            <div class="sidebar">
                  ...
                  <div class="list-group">
                    <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                      <div class="w-100 justify-content-between">
                        <img src="{{asset('assets/markedia/upload/small_07.jpg')}}" alt="" class="img-fluid float-left">
                    ...
                    <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                      <div class="w-100 justify-content-between">
                        <img src="{{asset('assets/markedia/upload/small_08.jpg')}}" alt="" class="img-fluid float-left">
                    ...
                    <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                      <div class="w-100 last-item justify-content-between">
                        <img src="{{asset('assets/markedia/upload/small_09.jpg')}}" alt="" class="img-fluid float-left">
              ...
              <div id="" class="widget">
                ...
                <div class="banner-spot clearfix">
                  <div class="banner-img">
                    <img src="{{asset('assets/markedia/upload/banner_03.jpg')}}" alt="" class="img-fluid">
                  </div><!-- end banner-img -->
                </div><!-- end banner -->
              </div><!-- end widget -->
              ...
              <div class="widget">
                ...
                <div class="instagram-wrapper clearfix">
                  <a class="" href="#"><img src="{{asset('assets/markedia/upload/small_09.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_01.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_02.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_03.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_04.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_05.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_06.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_07.jpg')}}" alt="" class="img-fluid"></a>
                  <a href="#"><img src="{{asset('assets/markedia/upload/small_08.jpg')}}" alt="" class="img-fluid"></a>
            ...
            <div class="widget">
              ...
              <div class="blog-list-widget">
                <div class="list-group">
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_04.jpg')}}" alt="" class="img-fluid float-left">
                      <h5 class="mb-1">5 Beautiful buildings you need to before dying</h5>
                      <small>12 Jan, 2016</small>
                    </div>
                  </a>
                  ...
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_05.jpg')}}" alt="" class="img-fluid float-left">
                      <h5 class="mb-1">Let's make an introduction for creative life</h5>
                      <small>11 Jan, 2016</small>
                    </div>
                  </a>
                  ...
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 last-item justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_06.jpg')}}" alt="" class="img-fluid float-left">
                      <h5 class="mb-1">Did you see the most beautiful sea in the world?</h5>
                      <small>07 Jan, 2016</small>
                    </div>
                  </a>
            ...
            <div class="widget">
              ...
              <div class="blog-list-widget">
                <div class="list-group">
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_01.jpg')}}" alt="" class="img-fluid float-left">
                  ...
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_02.jpg')}}" alt="" class="img-fluid float-left">
                  ...
                  <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 last-item justify-content-between">
                      <img src="{{asset('assets/markedia/upload/small_03.jpg')}}" alt="" class="img-fluid float-left">
  ...
  <script src="{{mix('assets/markedia/js/script.js')}}"></script>
